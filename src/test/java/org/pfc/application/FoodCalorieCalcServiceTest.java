...
class FoodCalorieCalcServiceTest {

    private FoodCalorieCalc foodCalorieCalc;

    @BeforeEach
    void setUp() {
        CalorieCalcService service = new CalorieCalcService();
        foodCalorieCalc = new FoodCalorieCalc(service);
    }
    ...
    public void testCalculateTotalCaloriesForRice() {
        int totalRiceCalories = foodCalorieCalc.calcTotalCalorie(2.5, 0.3, 37.1);
        ...
        assertEquals(161, totalRiceCalories);
    }
    ...
    public void testCalculateTotalCaloriesForNatto() {
        int totalNattoCalories = foodCalorieCalc.calcTotalCalorie(16.5, 10.0, 12.1);
        ...
        assertEquals(204, totalNattoCalories);
    }
    ...
    public void testCalculateTotalCaloriesForBanana() {
        int totalBananaCalories = foodCalorieCalc.calcTotalCalorie(3.8, 0.4, 78.5);
        ...
        assertEquals(333, totalBananaCalories);
    }
    ...
    public void testCheckMinusProtein() {
        IllegalArgumentException expected =
                assertThrows(IllegalArgumentException.class, () -> foodCalorieCalc.calcTotalCalorie(-2.5, 0.355, 37.155));
